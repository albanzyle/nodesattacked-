...
def twoNodesAttacked():
    ...
    controller_nodes=  [1,1,1,1,1,1,1,1]
    ...
    sa_attack_nodes = {
        1 : {35, 36, 7, 10, 43, 15, 48, 49, 17, 31},
        2 : {65, 37, 6, 39, 5, 74, 47, 49, 17, 26},
        3 : {1, 66, 7, 72, 14, 15, 48, 51, 54, 30},
        4 : {33, 35, 70, 71, 10, 12, 46, 21, 55, 61},
        5 : {32, 4, 37, 5, 40, 41, 11, 44, 25, 26},
        6 : {67, 39, 40, 72, 12, 57, 51, 25, 28, 31},
        7 : {33, 34, 7, 41, 45, 15, 23, 56, 58, 59},
        8 : {35, 4, 36, 38, 68, 8, 45, 21, 54, 31},
        9 : {65, 36, 73, 9, 49, 63, 20, 26, 61, 31},
        10 : {2, 69, 6, 73, 9, 42, 44, 20, 58, 27},
        11 : {1, 68, 69, 73, 74, 13, 52, 23, 26, 63},
        12 : {32, 2, 3, 68, 6, 8, 45, 17, 19, 52},
        13 : {34, 71, 11, 13, 46, 47, 48, 21, 60, 63},
        14 : {1, 27, 9, 42, 16, 51, 59, 60, 29, 63},
        15 : {33, 68, 9, 10, 13, 15, 23, 24, 57, 31},
        16 : {1, 41, 42, 48, 22, 57, 26, 59, 29, 30},
        17 : {33, 66, 37, 13, 49, 50, 21, 54, 57, 26},
        18 : {66, 2, 10, 44, 45, 49, 18, 51, 20, 26},
        19 : {32, 2, 3, 35, 37, 42, 13, 45, 52, 55},
        20 : {3, 67, 8, 14, 16, 21, 24, 29, 30, 31},
        21 : {33, 2, 66, 38, 9, 74, 47, 16, 52, 58},
        22 : {3, 36, 4, 71, 40, 74, 17, 18, 27, 30},
        23 : {67, 3, 36, 5, 69, 41, 11, 52, 55, 59},
        24 : {4, 36, 6, 7, 40, 74, 21, 58, 29, 62}}
